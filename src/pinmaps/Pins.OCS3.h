// -------------------------------------------------------------------------------------------------
// Pin map for OCS hardware version 3 using the Teensy3.5, 3.6, or 4.1
#pragma once
...
#define RELAY4_PIN              27  // RE4, SSR with 12V out option (32VAC/VDC 2A*)
                                    // * = 2.5A total combined for built-in 12V option
#define RELAY5_PIN              28  // RE5, high current n-channel power MOSFET (30VDC 30A)
#define RELAY6_PIN              29  // RE6, high current n-channel power MOSFET (30VDC 30A)
#define RELAY7_PIN              30  // RE7, mechanical relay (110/220VAC 16A)
...
#define RELAY11_PIN             34  // RE11, optional 8-channel ebay relay board
#define RELAY12_PIN             35  // RE12, optional 8-channel ebay relay board 
#define RELAY13_PIN             36  // RE13, optional 8-channel ebay relay board
#define RELAY14_PIN             37  // RE14, optional 8-channel ebay relay board
#define RELAY15_PIN             38  // RE15, optional 8-channel ebay relay board
#define RELAY16_PIN             39  // RE16, optional 8-channel ebay relay board
#if defined(ARDUINO_TEENSY41)
  #define RELAY17_PIN           40  // RE17, optional 8-channel ebay relay board
  #define RELAY18_PIN           41  // RE18, optional 8-channel ebay relay board
#else
  #define RELAY17_PIN           A21 // RE17, as above
  #define RELAY18_PIN           A22 // RE18, as above
#endif
