...
#include "Dome.h"
  ...
  #endif
  PID pidAxis3(&control3.in, &control3.out, &control3.set, DOME_SERVO_P, DOME_SERVO_I, DOME_SERVO_D, DIRECT);
  ...
  IRAM_ATTR void moveAxis3() { motor3.move(DOME_STEP_PIN); }
#endif
...
const AxisSettings SettingsAxis3 = {DOME_STEPS_PER_DEGREE, DOME_REVERSE, DOME_PARAMETER1, DOME_PARAMETER2, DOME_PARAMETER3, {DOME_LIMIT_MIN, DOME_LIMIT_MAX}, DOME_BACKLASH_RATE};
