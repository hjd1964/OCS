...
#include "Dome.h"
    ...
    ServoMotor motor1(1, &ServoPinsAxis1, &ServoSettingsAxis1, &encAxis1, &pidAxis1, &servoControlAxis1, false);
  #endif
    ...
    StepDirMotor motor1(1, &StepDirPinsAxis1, &StepDirSettingsAxis1, false);
  #endif
  ...
  Axis axis1(1, &PinsAxis1, &SettingsAxis1, AXIS_MEASURE_DEGREES);
      ...
      ServoMotor motor2(2, &ServoPinsAxis2, &ServoSettingsAxis2, &encAxis2, &pidAxis2, &servoControlAxis2, false);
    #endif
      ...
      StepDirMotor motor2(2, &StepDirPinsAxis2, &StepDirSettingsAxis2, false);
    #endif
