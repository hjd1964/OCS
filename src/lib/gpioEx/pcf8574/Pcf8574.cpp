...
#include "Pcf8574.h"
...
#ifndef GPIO_PCF8574_I2C_BASE_ADDRESS1
  #define GPIO_PCF8574_I2C_ADDRESS1 0x39
#endif
#ifndef GPIO_PCF8574_I2C_BASE_ADDRESS2
  #define GPIO_PCF8574_I2C_ADDRESS2 0x3A
#endif
#ifndef GPIO_PCF8574_I2C_BASE_ADDRESS3
  #define GPIO_PCF8574_I2C_ADDRESS3 0x3B
#endif
#ifndef GPIO_PCF8574_I2C_BASE_ADDRESS4
  ...
  #ifdef GPIO_PCF8574_I2C_BASE_ADDRESS2
    PCF8574 pcf1(HAL_WIRE, GPIO_PCF8574_I2C_BASE_ADDRESS2);
    #ifdef GPIO_PCF8574_I2C_BASE_ADDRESS3
      PCF8574 pcf2(HAL_WIRE, GPIO_PCF8574_I2C_BASE_ADDRESS3);
      #ifdef GPIO_PCF8574_I2C_BASE_ADDRESS4
        PCF8574 pcf3(HAL_WIRE, GPIO_PCF8574_I2C_BASE_ADDRESS4);
      #endif
    #endif
  #endif
#else
  ...
  #ifdef GPIO_PCF8574_I2C_BASE_ADDRESS2
    PCF8574 pcf1(GPIO_PCF8574_I2C_BASE_ADDRESS2);
    #ifdef GPIO_PCF8574_I2C_BASE_ADDRESS3
      PCF8574 pcf2(GPIO_PCF8574_I2C_BASE_ADDRESS3);
      #ifdef GPIO_PCF8574_I2C_BASE_ADDRESS4
        PCF8574 pcf3(GPIO_PCF8574_I2C_BASE_ADDRESS4);
      #endif
    #endif
  #endif
#endif
