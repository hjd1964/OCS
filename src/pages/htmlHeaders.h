...
const char html_main_css4[]  PROGMEM = ".b { padding: 10px; border-left: 5px solid #551111; overflow:hidden; border-right: 5px solid #551111; "
...
const char html_main_css8[]  PROGMEM = "a:link, a:visited { background-color: #332222; color: #a07070; border:1px solid red; "
...
const char html_main_css10[] PROGMEM = ".obsControl { position: relative; font-size: 14px; width: 260px; height: 190px; float:left; padding: 10px; margin: 10px; "
