  ...
  void indexPage() {
    {
      ...
      strcpy_P(temp, html_main_css_obsSwCtrl); www.sendContent(temp);
      strcpy_P(temp, html_main_css_obsWideSwCtrl); www.sendContent(temp);
      strcpy_P(temp, html_main_css_obsSwLine); www.sendContent(temp);
      strcpy_P(temp, html_main_css_obsControl); www.sendContent(temp);
      strcpy_P(temp, html_main_css_buttons); www.sendContent(temp);
