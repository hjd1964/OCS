...
const char html_links_index_end[] PROGMEM = "'>Overview</a>";

const char html_links_weather_begin[] PROGMEM = "<a href='/weatherpage.htm' ";
const char html_links_weather_end[] PROGMEM = "'>Weather</a>";

const char html_links_sky_begin[] PROGMEM = "<a href='/skypage.htm' ";
const char html_links_sky_end[] PROGMEM = "'>Sky Conditions</a>";
