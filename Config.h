...
#define ROR_SENSE_INTERLOCK           OFF //    OFF, n. Where n=1..6 (Sense#) Roof safety interlock, close allowed when ON.   Option
#define ROR_SENSE_LIMIT_CLOSED        OFF //    OFF, n. Where n=1..6 (Sense#) Roof closed switch (CLOSED when ON.)            Option
#define ROR_SENSE_LIMIT_OPENED        OFF //    OFF, n. Where n=1..6 (Sense#) Roof open switch (OPEN when ON.)                Option
...
// DEBUGGING -----------------------------------------------------------------------------------------------------------------------
#define DEBUG_WATCHDOG                ON  //    OFF, ON to enable debug code for watchdog.                                    Infreq
